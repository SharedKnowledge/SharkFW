...
//  public static final int HTTP = 4;
    ...
    /**
     *  Constant value representing the prefix of WifiDirect addresses
     */
    public static final String WIFI_DIRECT_PREFIX = "wifi://";
...
//            case HTTP: return "HTTP";
    ...
    public static int getValueByAddress(String address) throws SharkProtocolNotSupportedException {
        ...
        if (address.startsWith(WIFI_DIRECT_PREFIX)) return Protocols.WIFI_DIRECT;
        if (address.startsWith(BLUETOOTH_PREFIX)) return Protocols.BLUETOOTH;
...
//				return address.replaceFirst(Protocols.HTTP_PREFIX, "");
            case Protocols.BLUETOOTH:
                return address.replaceFirst(Protocols.BLUETOOTH_PREFIX, "");
            case Protocols.MAIL:
