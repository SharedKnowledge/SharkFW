 ...
 * @author thsc
 */
class DumpSemanticNet extends DumpSTSet implements SemanticNet {

    public DumpSemanticNet(DumpPersistentSharkKB aThis, SemanticNet semanticNet) {
        super(aThis, semanticNet);
    }
