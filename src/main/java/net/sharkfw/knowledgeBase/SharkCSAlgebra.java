...
//        }
    ...
    public static boolean identical(InformationCoordinates ic1, 
        ...
        if(ic1.getDirection() == ic2.getDirection() || 
          (ic1.getDirection() == ASIPSpace.DIRECTION_INOUT && ic2.getDirection() != ASIPSpace.DIRECTION_NOTHING) ||
          (ic1.getDirection() != ASIPSpace.DIRECTION_NOTHING && ic2.getDirection() == ASIPSpace.DIRECTION_INOUT)) {
    ...
    public static boolean identical(ContextCoordinates cc1, ContextCoordinates cc2) {
        ...
        if(cc1.getDirection() == cc2.getDirection() || 
          (cc1.getDirection() == ASIPSpace.DIRECTION_INOUT && cc2.getDirection() != ASIPSpace.DIRECTION_NOTHING) ||
          (cc1.getDirection() != ASIPSpace.DIRECTION_NOTHING && cc2.getDirection() == ASIPSpace.DIRECTION_INOUT)) {
