...
public class KeyHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        keyHandler = new KeyHandler(KeyPairAlgorithm.RSA, 1024);
    }

    @Test
    public void testGetPublicKey() throws Exception {
        assertNotNull(keyHandler.getPublicKey());
    }

    @Test
    public void testGetPrivateKey() throws Exception {
        assertNotNull(keyHandler.getPrivateKey());
    }

    @Test
    public void testGetRandomSessionKey() throws Exception {
        //Expected size of the returned byte array
        assertEquals(16, keyHandler.getRandomSessionKey(KeyAlgorithm.AES).length);
    }
}