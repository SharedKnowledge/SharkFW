...
/**
 * Diese Klasse biete die Funktionen der in J2ME verf�gbaren Math-implementierung
 * zusammen mit eigenen Implementierungen, die in J2ME fehlen (z.B. acos)
 * @author mfi
 */
...
public class Math
{
    ...
    public static double asin(double arg)
    {
        ...
        if(arg > 1)
            return nan;
        temp = java.lang.Math.sqrt(1 - arg*arg);
        if(arg > 0.7)
