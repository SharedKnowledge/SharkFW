...
public class SyncKB extends AbstractSharkKB {
    ...
    //                      constructor                                   //
    ////////////////////////////////////////////////////////////////////////
    public SyncKB(SharkKB kb){
		localKB = kb;
		java.util.Enumeration<ContextPoint> contextPoints = localkb.getAllContextPoints();
		while (contextPoints.hasMoreElements()) {
			ContextPoint cp = contextPoints.nextElement();
			java.util.Enumeration<Information> cpInformations = cp.enumInformation();
			while (cpInformations.hasMoreElements()) {
				Information information = cpInformations.nextElement();
				if (!information.getProperty(VERSION_PROPERTY_NAME)) {
