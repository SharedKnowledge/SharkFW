...
*/
    ...
    public void extract_nullPointerException() throws SharkKBException {
        ...
        ASIPSpace space5 = kbTest.createASIPSpace(htwBerlin, null, null, (PeerSTSet) null, null, null, locations, DIRECTION_INOUT);
        ...
        ASIPSpace inter1 = blubb.createASIPSpace(null, null, null, (PeerSTSet) null, null, null, null, DIRECTION_INOUT);
        // Space which should give 4 informations back, all with loc1
        ASIPSpace inter2 = blubb.createASIPSpace(null, null, null, (PeerSTSet) null, null, null, locations, DIRECTION_INOUT);
        // Space which should give 2 informations back, all with loc1 and with topic2
        ASIPSpace inter3 = blubb.createASIPSpace(find1, null, null, (PeerSTSet) null, null, null, locations, DIRECTION_INOUT);
        // Space which should give 1 information back, with loc1 and with topic2 and topic3
        ASIPSpace inter4 = blubb.createASIPSpace(htwBerlin, null, null, (PeerSTSet) null, null, null, locations, DIRECTION_INOUT);
